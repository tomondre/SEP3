...
public class Customer
{
  ...
  @SerializedName(value = "firstName", alternate = {
      "FirstName"}) @Nullable @Column(name = "first_name") private String firstName;

  @SerializedName(value = "lastName", alternate = {
      "LastName"}) @Nullable @Column(name = "last_name") private String lastName;
  ...
  @SerializedName(value = "address", alternate = {
      "Address"}) @Nullable @ManyToOne(cascade = CascadeType.ALL) private Address address;

  @OneToOne @MapsId @PrimaryKeyJoinColumn(name = "user_id") private User user;
